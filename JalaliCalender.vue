      ...
      <table style="width: 100%;">
        ...
        >
          <button
            ...
            :key="index"
            :class="{
              'datePicker--active': state.year === year,
              'btn btn-outline-light': 1 === 1
            }"
        ...
        <thead>
          <tr>
            ...
            <th style="margin-left: 43px;">
              <button
                style="height: 30px;text-align: center;line-height: 12px;margin-top: 3px;"
                class="btn btn-outline-light"
                type="button"
                @click="openYearList"
              >
